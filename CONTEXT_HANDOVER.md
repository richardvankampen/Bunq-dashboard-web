...
- Tegeltrends (`calculateTileTrend`): periode ≥60 dagen en ≥2 volledige maanden → laatste volledige maand vs gemiddelde van tot 3 eerdere volledige maanden in de periode; anders tweede helft vs eerste helft (`calculateHalfPeriodChange`); `n.v.t.` als de basis ~0 is; tooltip noemt de basis.
